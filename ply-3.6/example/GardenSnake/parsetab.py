...
# C:\Users\Alon\Desktop\CSC3003S\compilers-assignment-1\ply-3.6\example\GardenSnake\parsetab.py
...
_lr_productions = [
  ...
  ('file_input_end -> file_input ENDMARKER','file_input_end',2,'p_file_input_end','GardenSnake.py',362),
  ('file_input -> file_input NEWLINE','file_input',2,'p_file_input','GardenSnake.py',365),
  ('file_input -> file_input stmt','file_input',2,'p_file_input','GardenSnake.py',366),
  ('file_input -> NEWLINE','file_input',1,'p_file_input','GardenSnake.py',367),
  ('file_input -> stmt','file_input',1,'p_file_input','GardenSnake.py',368),
  ('funcdef -> DEF NAME parameters COLON suite','funcdef',5,'p_funcdef','GardenSnake.py',384),
  ('parameters -> LPAR RPAR','parameters',2,'p_parameters','GardenSnake.py',389),
  ('parameters -> LPAR varargslist RPAR','parameters',3,'p_parameters','GardenSnake.py',390),
  ('varargslist -> varargslist COMMA NAME','varargslist',3,'p_varargslist','GardenSnake.py',400),
  ('varargslist -> NAME','varargslist',1,'p_varargslist','GardenSnake.py',401),
  ('stmt -> simple_stmt','stmt',1,'p_stmt_simple','GardenSnake.py',409),
  ('stmt -> compound_stmt','stmt',1,'p_stmt_compound','GardenSnake.py',414),
  ('simple_stmt -> small_stmts NEWLINE','simple_stmt',2,'p_simple_stmt','GardenSnake.py',419),
  ('simple_stmt -> small_stmts SEMICOLON NEWLINE','simple_stmt',3,'p_simple_stmt','GardenSnake.py',420),
  ('small_stmts -> small_stmts SEMICOLON small_stmt','small_stmts',3,'p_small_stmts','GardenSnake.py',424),
  ('small_stmts -> small_stmt','small_stmts',1,'p_small_stmts','GardenSnake.py',425),
  ('small_stmt -> flow_stmt','small_stmt',1,'p_small_stmt','GardenSnake.py',434),
  ('small_stmt -> expr_stmt','small_stmt',1,'p_small_stmt','GardenSnake.py',435),
  ('expr_stmt -> testlist ASSIGN testlist','expr_stmt',3,'p_expr_stmt','GardenSnake.py',443),
  ('expr_stmt -> testlist','expr_stmt',1,'p_expr_stmt','GardenSnake.py',444),
  ('flow_stmt -> return_stmt','flow_stmt',1,'p_flow_stmt','GardenSnake.py',452),
  ('return_stmt -> RETURN testlist','return_stmt',2,'p_return_stmt','GardenSnake.py',457),
  ('compound_stmt -> if_stmt','compound_stmt',1,'p_compound_stmt','GardenSnake.py',462),
  ('compound_stmt -> funcdef','compound_stmt',1,'p_compound_stmt','GardenSnake.py',463),
  ('if_stmt -> IF test COLON suite','if_stmt',4,'p_if_stmt','GardenSnake.py',467),
  ('suite -> simple_stmt','suite',1,'p_suite','GardenSnake.py',471),
  ('suite -> NEWLINE INDENT stmts DEDENT','suite',4,'p_suite','GardenSnake.py',472),
  ('stmts -> stmts stmt','stmts',2,'p_stmts','GardenSnake.py',480),
  ('stmts -> stmt','stmts',1,'p_stmts','GardenSnake.py',481),
  ('comparison -> comparison PLUS comparison','comparison',3,'p_comparison','GardenSnake.py',523),
  ('comparison -> comparison MINUS comparison','comparison',3,'p_comparison','GardenSnake.py',524),
  ('comparison -> comparison MULT comparison','comparison',3,'p_comparison','GardenSnake.py',525),
  ('comparison -> comparison DIV comparison','comparison',3,'p_comparison','GardenSnake.py',526),
  ('comparison -> comparison LT comparison','comparison',3,'p_comparison','GardenSnake.py',527),
  ('comparison -> comparison EQ comparison','comparison',3,'p_comparison','GardenSnake.py',528),
  ('comparison -> comparison GT comparison','comparison',3,'p_comparison','GardenSnake.py',529),
  ('comparison -> PLUS comparison','comparison',2,'p_comparison','GardenSnake.py',530),
  ('comparison -> MINUS comparison','comparison',2,'p_comparison','GardenSnake.py',531),
  ('comparison -> power','comparison',1,'p_comparison','GardenSnake.py',532),
  ('power -> atom','power',1,'p_power','GardenSnake.py',544),
  ('power -> atom trailer','power',2,'p_power','GardenSnake.py',545),
  ('atom -> NAME','atom',1,'p_atom_name','GardenSnake.py',555),
  ('atom -> NUMBER','atom',1,'p_atom_number','GardenSnake.py',559),
  ('atom -> STRING','atom',1,'p_atom_number','GardenSnake.py',560),
  ('atom -> LPAR testlist RPAR','atom',3,'p_atom_tuple','GardenSnake.py',564),
  ('trailer -> LPAR arglist RPAR','trailer',3,'p_trailer','GardenSnake.py',569),
  ('testlist -> testlist_multi COMMA','testlist',2,'p_testlist','GardenSnake.py',575),
  ('testlist -> testlist_multi','testlist',1,'p_testlist','GardenSnake.py',576),
  ('testlist_multi -> testlist_multi COMMA test','testlist_multi',3,'p_testlist_multi','GardenSnake.py',590),
  ('testlist_multi -> test','testlist_multi',1,'p_testlist_multi','GardenSnake.py',591),
  ('test -> comparison','test',1,'p_test','GardenSnake.py',606),
  ('arglist -> arglist COMMA argument','arglist',3,'p_arglist','GardenSnake.py',614),
  ('arglist -> argument','arglist',1,'p_arglist','GardenSnake.py',615),
  ('argument -> test','argument',1,'p_argument','GardenSnake.py',623),
]
